...
public class AuthController {
    ...
    @PostMapping("/register")   // This method will handle POST requests sent to /auth/register
    public ResponseEntity<Response> register(@RequestBody User user) {// It expects a User object in the request body and returns a ResponseEntity with the registration result
