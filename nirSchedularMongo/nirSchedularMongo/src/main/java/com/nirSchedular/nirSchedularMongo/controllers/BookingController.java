...
public class BookingController {
    ...
    // Endpoint for appointment booking (accessible to ADMIN and USER)
    @PostMapping("/bookings/book-appointment/{appointmentId}/{userId}")
    @PreAuthorize("hasAuthority('ADMIN') or hasAuthority('USER')")
    public ResponseEntity<Response> saveBooking(
            @PathVariable String appointmentId, // Appointment ID passed as a path variable
        ...
        Response response = bookingService.saveBooking(appointmentId, userId, bookingRequest);
...
saveBooking: Allows a user or admin to book a appointment by sending a POST request with booking details.
